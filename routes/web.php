...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('komoditas', KomoditasController::class)->except(['show', 'edit', 'update']);
    Route::post('komoditas/{komoditas}/accept', [KomoditasController::class, 'accept'])->name('komoditas.update');
    Route::get('komoditas/{komoditas}/refuse', [KomoditasController::class, 'refuse'])->name('komoditas.update');
});
