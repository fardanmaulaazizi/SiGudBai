    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/images/banner1.png" class="d-block w-100 object-fit-cover" height="450px"
                    alt="Banner Pasar Cabai">
            </div>
            <div class="carousel-item">
                <img src="/images/banner2.png" class="d-block w-100 object-fit-cover" height="450px"
                    alt="Banner Pasar Cabai">
            </div>
            <div class="carousel-item">
                <img src="/images/banner3.png" class="d-block w-100 object-fit-cover" height="450px"
                    alt="Banner Pasar Cabai">
            </div>
        </div>
